...
function Gig() {
  const { id } = useParams()// to get gig id
  ...
  const { isLoading:isLoadingUser, error:errorUser, data:dataUser } = useQuery({// runs when the page is rendered
    queryKey: ['user'],
    queryFn: () =>
      newRequest
        .get(
        ...
        <div className="right">
          ...
          <div className="details">
            <div className="item">
              ...
              <span>{data.delievery} Days Delivery</span>
            </div>
            <div className="item">
